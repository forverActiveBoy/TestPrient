...
public class Test{
    ...
    public static final String USER = "extends_zkx0924@163.com";//*必填*：账号名
    public static final String UKEY = "ZbRQ8rjskvuXkCWr";//*必填*: 注册账号后生成的UKEY
    public static final String SN = "817005699";//*必填*：打印机编号，必须要在管理后台里添加打印机或调用API接口添加之后，才能调用API
